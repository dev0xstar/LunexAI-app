        ...
        return (
          ...
          (function (t, e, n, o) {
            ...
            return (
              ...
              isNaN(o) && (o = l.getBestMask(A, m.bind(null, A, n))),
              l.applyMask(o, A),
              m(A, n, o),
              {
                modules: A,
      ...
      (e.fromArray = function (t) {
        ...
        (e.fromString = function (t, n) {
          let o = g(t, l.isKanjiModeEnabled()),
            ...
            s = [];
          for (let t = 1; t < a.length - 1; t++) s.push(u.table[a[t]].node);
          return e.fromArray(
        ...
        (e.qrToImageData = function (t, n, r) {
          ...
          for (let e = 0; e < a; e++)
            for (let n = 0; n < a; n++) {
              let f = (e * a + n) * 4,
                c = r.color.light;
              if (e >= s && n >= s && e < a - s && n < a - s) {
                let t = Math.floor((e - s) / u),
                  r = Math.floor((n - s) / u);
                c = l[i[t * o + r] ? 1 : 0];
              }
